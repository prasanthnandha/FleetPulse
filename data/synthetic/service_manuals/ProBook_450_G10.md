# ProBook 450 G10 — Service Manual
...
14. Position the new battery (HPQ-BAT-D46303) in the bay, pressing firmly to seat.
...
**Part Number:** `HPQ-DSP-7A16FB`
**Supplier:** JDI
**Cost:** $93.97
**Estimated Repair Time:** 1.7 hours
...
13. Connect the new display (HPQ-DSP-7A16FB) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (HPQ-MLB-D33ED8).
...
5. Locate the charging port flex cable. It typically runs along the bottom-left corner.
...
11. Position the new charging port (HPQ-CHG-750F2B) and secure with screws.
...
8. Position the new camera module (HPQ-CAM-0CAB25) and secure.
...
8. Position the new speaker (HPQ-SPK-8CAEFB) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (HPQ-ANT-79F101) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (HPQ-STO-683AFA) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new keyboard (HPQ-KBD-2D3EE4) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new trackpad (HPQ-TPD-932E9E) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
