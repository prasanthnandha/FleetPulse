# EliteBook 840 G10 — Service Manual
...
14. Position the new battery (HPQ-BAT-FF9DE6) in the bay, pressing firmly to seat.
...
13. Connect the new display (HPQ-DSP-F75683) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (HPQ-MLB-CA316F).
...
11. Position the new charging port (HPQ-CHG-2BF9F6) and secure with screws.
...
8. Position the new camera module (HPQ-CAM-162D40) and secure.
...
8. Position the new speaker (HPQ-SPK-D76C3C) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (HPQ-ANT-7D610C) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (HPQ-STO-8E2991) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new keyboard (HPQ-KBD-B16347) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new trackpad (HPQ-TPD-707CD9) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
