...
14. Position the new battery (DLL-BAT-0F8CC1) in the bay, pressing firmly to seat.
...
13. Connect the new display (DLL-DSP-14AD13) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (DLL-MLB-93D50B).
...
11. Position the new charging port (DLL-CHG-5B6747) and secure with screws.
...
8. Position the new camera module (DLL-CAM-8687F8) and secure.
...
8. Position the new speaker (DLL-SPK-7E9868) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (DLL-ANT-C08953) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (DLL-STO-E23739) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new keyboard (DLL-KBD-47A3A6) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new trackpad (DLL-TPD-79952E) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
