# ThinkPad T14s Gen 4 — Service Manual
...
14. Position the new battery (LNV-BAT-47A136) in the bay, pressing firmly to seat.
...
13. Connect the new display (LNV-DSP-175822) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (LNV-MLB-4DE936).
...
11. Position the new charging port (LNV-CHG-2C2894) and secure with screws.
...
8. Position the new camera module (LNV-CAM-129C28) and secure.
...
8. Position the new speaker (LNV-SPK-D60D3C) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (LNV-ANT-74DC5A) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (LNV-STO-EC6955) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new keyboard (LNV-KBD-1A9F77) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
**Part Number:** `LNV-TPD-69B427`
**Supplier:** Alps Alpine
**Cost:** $74.58
**Estimated Repair Time:** 0.6 hours
**Difficulty:** Easy (★★☆☆☆)
**Availability:** in_stock
...
8. Position the new trackpad (LNV-TPD-69B427) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
