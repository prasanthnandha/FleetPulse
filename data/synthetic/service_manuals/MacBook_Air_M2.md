...
14. Position the new battery (APL-BAT-5E1EAD) in the bay, pressing firmly to seat.
...
13. Connect the new display (APL-DSP-7B180B) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (APL-MLB-5D45B5).
...
11. Position the new charging port (APL-CHG-B261F0) and secure with screws.
...
8. Position the new camera module (APL-CAM-CBECC1) and secure.
...
8. Position the new speaker (APL-SPK-1252E5) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (APL-ANT-27F346) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (APL-STO-60DC74) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new keyboard (APL-KBD-4C1B3B) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new trackpad (APL-TPD-7C33FF) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
