...
14. Position the new battery (DLL-BAT-F2BC96) in the bay, pressing firmly to seat.
...
13. Connect the new display (DLL-DSP-908C64) flex cables to the logic board.
...
**Part Number:** `DLL-MLB-D95F29`
**Supplier:** Foxconn
**Cost:** $332.26
**Estimated Repair Time:** 3.9 hours
**Difficulty:** Expert (★★★★★)
**Availability:** in_stock
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (DLL-MLB-D95F29).
...
11. Position the new charging port (DLL-CHG-D74C8E) and secure with screws.
...
8. Position the new camera module (DLL-CAM-901104) and secure.
...
8. Position the new speaker (DLL-SPK-80A757) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (DLL-ANT-1648E7) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (DLL-STO-526CB0) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new keyboard (DLL-KBD-FC7F3B) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new trackpad (DLL-TPD-C7BC44) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
