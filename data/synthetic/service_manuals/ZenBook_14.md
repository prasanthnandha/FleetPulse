...
14. Position the new battery (ASU-BAT-155810) in the bay, pressing firmly to seat.
...
13. Connect the new display (ASU-DSP-CC77E4) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (ASU-MLB-BB0F40).
...
11. Position the new charging port (ASU-CHG-1A55F9) and secure with screws.
...
8. Position the new camera module (ASU-CAM-9A2EEB) and secure.
...
8. Position the new speaker (ASU-SPK-A4E3B1) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (ASU-ANT-C4D2FE) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (ASU-STO-1875B3) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new keyboard (ASU-KBD-31E436) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new trackpad (ASU-TPD-A568A8) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
