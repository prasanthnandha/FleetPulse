...
14. Position the new battery (SNY-BAT-556448) in the bay, pressing firmly to seat.
...
13. Connect the new display (SNY-DSP-77FF08) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (SNY-MLB-083D4F).
...
11. Position the new charging port (SNY-CHG-8C3B5F) and secure with screws.
...
8. Position the new camera module (SNY-CAM-A8F6F6) and secure.
...
8. Position the new speaker (SNY-SPK-CB76BB) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (SNY-ANT-47171B) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (SNY-STO-863FC5) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
