...
14. Position the new battery (APL-BAT-09AFC0) in the bay, pressing firmly to seat.
...
13. Connect the new display (APL-DSP-8E6F38) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (APL-MLB-22B6F5).
...
11. Position the new charging port (APL-CHG-360C58) and secure with screws.
...
8. Position the new camera module (APL-CAM-6BB9FB) and secure.
...
8. Position the new speaker (APL-SPK-E722CD) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (APL-ANT-090042) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (APL-STO-192838) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
