...
14. Position the new battery (GGL-BAT-DF31C5) in the bay, pressing firmly to seat.
...
13. Connect the new display (GGL-DSP-7E1C56) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (GGL-MLB-A53258).
...
11. Position the new charging port (GGL-CHG-16EB70) and secure with screws.
...
8. Position the new camera module (GGL-CAM-6C9E5D) and secure.
...
8. Position the new speaker (GGL-SPK-DB892D) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (GGL-ANT-37A483) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (GGL-STO-4720F4) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
