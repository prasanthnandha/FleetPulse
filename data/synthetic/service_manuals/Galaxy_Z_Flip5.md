...
14. Position the new battery (SAM-BAT-35478E) in the bay, pressing firmly to seat.
...
13. Connect the new display (SAM-DSP-8DC49A) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (SAM-MLB-73D73F).
...
11. Position the new charging port (SAM-CHG-1CA3A0) and secure with screws.
...
8. Position the new camera module (SAM-CAM-F1C6E6) and secure.
...
8. Position the new speaker (SAM-SPK-C273B1) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (SAM-ANT-170F48) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (SAM-STO-B00B46) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
