# Moto Edge 40 Pro — Service Manual
...
14. Position the new battery (MOT-BAT-DFBBEC) in the bay, pressing firmly to seat.
...
13. Connect the new display (MOT-DSP-C5F8C9) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (MOT-MLB-60170A).
...
11. Position the new charging port (MOT-CHG-B30061) and secure with screws.
...
8. Position the new camera module (MOT-CAM-760179) and secure.
...
8. Position the new speaker (MOT-SPK-C3A3BF) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (MOT-ANT-6B33B0) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (MOT-STO-0ADDA3) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
