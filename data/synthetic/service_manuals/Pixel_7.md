...
14. Position the new battery (GGL-BAT-DCE6BD) in the bay, pressing firmly to seat.
...
13. Connect the new display (GGL-DSP-57EA90) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (GGL-MLB-1D721B).
...
11. Position the new charging port (GGL-CHG-120A04) and secure with screws.
...
8. Position the new camera module (GGL-CAM-CD61C7) and secure.
...
8. Position the new speaker (GGL-SPK-E1E515) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (GGL-ANT-64DD8B) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (GGL-STO-A3FF04) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
