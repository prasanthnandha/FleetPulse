...
14. Position the new battery (APL-BAT-A49C72) in the bay, pressing firmly to seat.
...
13. Connect the new display (APL-DSP-963BD6) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (APL-MLB-C19A02).
...
11. Position the new charging port (APL-CHG-A69DCD) and secure with screws.
...
8. Position the new camera module (APL-CAM-8CD24F) and secure.
...
8. Position the new speaker (APL-SPK-704615) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (APL-ANT-A747A5) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (APL-STO-1A13EE) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
