...
14. Position the new battery (SAM-BAT-46A939) in the bay, pressing firmly to seat.
...
13. Connect the new display (SAM-DSP-9636A9) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (SAM-MLB-9866FB).
...
11. Position the new charging port (SAM-CHG-B89815) and secure with screws.
...
8. Position the new camera module (SAM-CAM-A63A1F) and secure.
...
8. Position the new speaker (SAM-SPK-C18863) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (SAM-ANT-A106D1) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (SAM-STO-3DE66A) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
