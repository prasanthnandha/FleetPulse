...
14. Position the new battery (SAM-BAT-F76C31) in the bay, pressing firmly to seat.
...
13. Connect the new display (SAM-DSP-F87EA5) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (SAM-MLB-341C60).
...
11. Position the new charging port (SAM-CHG-923E83) and secure with screws.
...
8. Position the new camera module (SAM-CAM-885005) and secure.
...
8. Position the new speaker (SAM-SPK-370EB1) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (SAM-ANT-C7BB0F) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (SAM-STO-600362) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
