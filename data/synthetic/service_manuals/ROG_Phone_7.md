...
14. Position the new battery (ASU-BAT-224F97) in the bay, pressing firmly to seat.
...
13. Connect the new display (ASU-DSP-4D3DE2) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (ASU-MLB-A01092).
...
11. Position the new charging port (ASU-CHG-00DBE9) and secure with screws.
...
8. Position the new camera module (ASU-CAM-14FECD) and secure.
...
8. Position the new speaker (ASU-SPK-77FB4F) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (ASU-ANT-A65FE4) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (ASU-STO-46B195) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
