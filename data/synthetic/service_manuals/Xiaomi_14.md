...
14. Position the new battery (XMI-BAT-661AF7) in the bay, pressing firmly to seat.
...
13. Connect the new display (XMI-DSP-12E0FD) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (XMI-MLB-7AA6AF).
...
11. Position the new charging port (XMI-CHG-702D7E) and secure with screws.
...
8. Position the new camera module (XMI-CAM-9F3FD8) and secure.
...
8. Position the new speaker (XMI-SPK-2754D8) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (XMI-ANT-7E601E) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (XMI-STO-8B2DBE) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
