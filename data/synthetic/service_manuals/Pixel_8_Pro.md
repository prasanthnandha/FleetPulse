...
14. Position the new battery (GGL-BAT-70BE0F) in the bay, pressing firmly to seat.
...
13. Connect the new display (GGL-DSP-934176) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (GGL-MLB-8F0F3B).
...
11. Position the new charging port (GGL-CHG-BEEB5A) and secure with screws.
...
8. Position the new camera module (GGL-CAM-204121) and secure.
...
8. Position the new speaker (GGL-SPK-40EF35) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (GGL-ANT-44F060) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (GGL-STO-63BC93) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
