# iPad Pro 12.9 M2 — Service Manual
...
14. Position the new battery (APL-BAT-056CD2) in the bay, pressing firmly to seat.
...
13. Connect the new display (APL-DSP-2C0C5C) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (APL-MLB-3BFDFB).
...
11. Position the new charging port (APL-CHG-DC8BC5) and secure with screws.
...
8. Position the new camera module (APL-CAM-2C1084) and secure.
...
8. Position the new speaker (APL-SPK-EDC33B) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (APL-ANT-C41841) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (APL-STO-9A0F23) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
