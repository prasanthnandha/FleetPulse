...
14. Position the new battery (MSF-BAT-699F1D) in the bay, pressing firmly to seat.
...
13. Connect the new display (MSF-DSP-0C2296) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (MSF-MLB-539E7A).
...
11. Position the new charging port (MSF-CHG-DFCD10) and secure with screws.
...
8. Position the new camera module (MSF-CAM-15095C) and secure.
...
8. Position the new speaker (MSF-SPK-70FF72) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (MSF-ANT-193B19) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (MSF-STO-6870BF) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
