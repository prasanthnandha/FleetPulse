...
14. Position the new battery (DLL-BAT-500A13) in the bay, pressing firmly to seat.
...
13. Connect the new display (DLL-DSP-4B58E6) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (DLL-MLB-776A0A).
...
11. Position the new charging port (DLL-CHG-CA91FC) and secure with screws.
...
8. Position the new camera module (DLL-CAM-2A1834) and secure.
...
8. Position the new speaker (DLL-SPK-EDF2D2) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (DLL-ANT-44AA08) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (DLL-STO-F362C2) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new keyboard (DLL-KBD-010E39) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new trackpad (DLL-TPD-3D6D7B) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
