...
14. Position the new battery (APL-BAT-81976A) in the bay, pressing firmly to seat.
...
13. Connect the new display (APL-DSP-B8C67F) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (APL-MLB-47D70A).
...
11. Position the new charging port (APL-CHG-A6B62B) and secure with screws.
...
8. Position the new camera module (APL-CAM-005674) and secure.
...
8. Position the new speaker (APL-SPK-3A1DBC) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (APL-ANT-BFE52D) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (APL-STO-CA1CEB) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
