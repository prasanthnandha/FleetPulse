# MacBook Pro 14 M3 — Service Manual
...
14. Position the new battery (APL-BAT-2760D4) in the bay, pressing firmly to seat.
...
13. Connect the new display (APL-DSP-E9B299) flex cables to the logic board.
...
**Part Number:** `APL-MLB-9266BF`
**Supplier:** Foxconn
**Cost:** $435.43
**Estimated Repair Time:** 3.7 hours
**Difficulty:** Expert (★★★★★)
**Availability:** in_stock
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (APL-MLB-9266BF).
...
11. Position the new charging port (APL-CHG-6708D3) and secure with screws.
...
8. Position the new camera module (APL-CAM-A75091) and secure.
...
8. Position the new speaker (APL-SPK-0FAEC2) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (APL-ANT-176246) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (APL-STO-DAC123) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new keyboard (APL-KBD-FC1762) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new trackpad (APL-TPD-585CA8) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
