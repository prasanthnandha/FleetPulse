# Galaxy Book3 Pro — Service Manual
...
14. Position the new battery (SAM-BAT-1DD3DA) in the bay, pressing firmly to seat.
...
13. Connect the new display (SAM-DSP-D46AD1) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (SAM-MLB-849A6B).
...
11. Position the new charging port (SAM-CHG-B7EC61) and secure with screws.
...
8. Position the new camera module (SAM-CAM-D763D7) and secure.
...
8. Position the new speaker (SAM-SPK-27D02B) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (SAM-ANT-B19D32) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (SAM-STO-D21D2C) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new keyboard (SAM-KBD-E87FD5) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new trackpad (SAM-TPD-14A765) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
