...
14. Position the new battery (OPL-BAT-A7AB9B) in the bay, pressing firmly to seat.
...
13. Connect the new display (OPL-DSP-ECB48C) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (OPL-MLB-525F85).
...
11. Position the new charging port (OPL-CHG-D30189) and secure with screws.
...
8. Position the new camera module (OPL-CAM-6855C0) and secure.
...
8. Position the new speaker (OPL-SPK-5DE4A7) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (OPL-ANT-2A8B41) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (OPL-STO-F4ADE8) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
