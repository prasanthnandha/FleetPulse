...
14. Position the new battery (APL-BAT-65B556) in the bay, pressing firmly to seat.
...
13. Connect the new display (APL-DSP-6AD514) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (APL-MLB-000114).
...
11. Position the new charging port (APL-CHG-67FF20) and secure with screws.
...
8. Position the new camera module (APL-CAM-7D0744) and secure.
...
8. Position the new speaker (APL-SPK-33FAE0) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (APL-ANT-E88DC2) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (APL-STO-1E6410) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
