...
14. Position the new battery (APL-BAT-B99E52) in the bay, pressing firmly to seat.
...
13. Connect the new display (APL-DSP-7C0D94) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (APL-MLB-E0ADC1).
...
11. Position the new charging port (APL-CHG-DA0573) and secure with screws.
...
8. Position the new camera module (APL-CAM-34ED68) and secure.
...
8. Position the new speaker (APL-SPK-D34FC7) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (APL-ANT-1EEC37) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (APL-STO-DAAA0D) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
