...
14. Position the new battery (SAM-BAT-9A4687) in the bay, pressing firmly to seat.
...
13. Connect the new display (SAM-DSP-640BEA) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (SAM-MLB-2111F2).
...
11. Position the new charging port (SAM-CHG-CAF8DF) and secure with screws.
...
8. Position the new camera module (SAM-CAM-4F3721) and secure.
...
8. Position the new speaker (SAM-SPK-D19916) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (SAM-ANT-205EE3) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (SAM-STO-8359C3) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
