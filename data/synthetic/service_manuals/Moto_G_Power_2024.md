# Moto G Power 2024 — Service Manual
...
14. Position the new battery (MOT-BAT-14243D) in the bay, pressing firmly to seat.
...
13. Connect the new display (MOT-DSP-A535A8) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (MOT-MLB-4CC8DE).
...
11. Position the new charging port (MOT-CHG-B5C4D7) and secure with screws.
...
8. Position the new camera module (MOT-CAM-423F16) and secure.
...
8. Position the new speaker (MOT-SPK-A7816C) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (MOT-ANT-86A740) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (MOT-STO-76119D) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
