# Chromebook Pixel — Service Manual
...
14. Position the new battery (GGL-BAT-109262) in the bay, pressing firmly to seat.
...
13. Connect the new display (GGL-DSP-8C1F1D) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (GGL-MLB-995C95).
...
11. Position the new charging port (GGL-CHG-6F8C59) and secure with screws.
...
8. Position the new camera module (GGL-CAM-CF5444) and secure.
...
8. Position the new speaker (GGL-SPK-4B7C35) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (GGL-ANT-9F3511) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (GGL-STO-E2BAED) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
