...
14. Position the new battery (APL-BAT-E3166A) in the bay, pressing firmly to seat.
...
13. Connect the new display (APL-DSP-E8407A) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (APL-MLB-C72A69).
...
11. Position the new charging port (APL-CHG-9F0FF1) and secure with screws.
...
8. Position the new camera module (APL-CAM-7C8274) and secure.
...
8. Position the new speaker (APL-SPK-E824A0) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (APL-ANT-EC6625) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (APL-STO-E4F488) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
