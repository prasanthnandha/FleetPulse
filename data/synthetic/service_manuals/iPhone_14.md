...
2. Remove the Pentalobe screws from the bottom edge of the device using the appropriate screwdriver.
...
14. Position the new battery (APL-BAT-55EB1A) in the bay, pressing firmly to seat.
...
2. Remove the Pentalobe screws from the bottom edge.
...
13. Connect the new display (APL-DSP-95C06D) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (APL-MLB-F0A2FC).
...
11. Position the new charging port (APL-CHG-8C8C1E) and secure with screws.
...
**Part Number:** `APL-CAM-7D334B`
**Supplier:** Sony Semiconductor
**Cost:** $119.84
**Estimated Repair Time:** 1.7 hours
**Difficulty:** Moderate (★★★☆☆)
**Availability:** in_stock
...
8. Position the new camera module (APL-CAM-7D334B) and secure.
...
8. Position the new speaker (APL-SPK-1D0087) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (APL-ANT-31D050) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
**Part Number:** `APL-STO-1110F2`
**Supplier:** SK Hynix
**Cost:** $138.76
**Estimated Repair Time:** 2.9 hours
**Difficulty:** Moderate (★★★☆☆)
**Availability:** in_stock
...
8. Position the new storage (APL-STO-1110F2) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
