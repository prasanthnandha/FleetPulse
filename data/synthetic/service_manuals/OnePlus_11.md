...
14. Position the new battery (OPL-BAT-F527E0) in the bay, pressing firmly to seat.
...
13. Connect the new display (OPL-DSP-811080) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (OPL-MLB-D9584A).
...
11. Position the new charging port (OPL-CHG-95952F) and secure with screws.
...
8. Position the new camera module (OPL-CAM-21F2E7) and secure.
...
8. Position the new speaker (OPL-SPK-64CE8C) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (OPL-ANT-BFAD82) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (OPL-STO-6C2600) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
