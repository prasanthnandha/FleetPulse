# Spectre x360 14 — Service Manual
...
14. Position the new battery (HPQ-BAT-42F8C4) in the bay, pressing firmly to seat.
...
13. Connect the new display (HPQ-DSP-C21726) flex cables to the logic board.
...
**Part Number:** `HPQ-MLB-787CDD`
**Supplier:** Foxconn
**Cost:** $284.28
**Estimated Repair Time:** 3.2 hours
**Difficulty:** Expert (★★★★★)
**Availability:** in_stock
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (HPQ-MLB-787CDD).
...
11. Position the new charging port (HPQ-CHG-0BC0E9) and secure with screws.
...
8. Position the new camera module (HPQ-CAM-3EAF1B) and secure.
...
8. Position the new speaker (HPQ-SPK-18FDE1) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (HPQ-ANT-1DD3AD) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (HPQ-STO-823541) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new keyboard (HPQ-KBD-461600) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new trackpad (HPQ-TPD-403E14) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
