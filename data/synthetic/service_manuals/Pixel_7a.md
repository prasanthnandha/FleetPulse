...
2. Remove the Torx T3 screws from the bottom edge of the device using the appropriate screwdriver.
...
14. Position the new battery (GGL-BAT-B1F8BF) in the bay, pressing firmly to seat.
...
2. Remove the Torx T3 screws from the bottom edge.
...
13. Connect the new display (GGL-DSP-ED3932) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (GGL-MLB-74F040).
...
11. Position the new charging port (GGL-CHG-4F8A7A) and secure with screws.
...
8. Position the new camera module (GGL-CAM-692ABC) and secure.
...
8. Position the new speaker (GGL-SPK-22A8AD) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (GGL-ANT-8FB1D5) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (GGL-STO-9BDA2F) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
