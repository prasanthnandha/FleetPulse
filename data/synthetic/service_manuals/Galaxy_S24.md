...
14. Position the new battery (SAM-BAT-6030D3) in the bay, pressing firmly to seat.
...
13. Connect the new display (SAM-DSP-7BEDB2) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (SAM-MLB-176DA9).
...
11. Position the new charging port (SAM-CHG-B65106) and secure with screws.
...
8. Position the new camera module (SAM-CAM-FD60CB) and secure.
...
8. Position the new speaker (SAM-SPK-0AD791) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (SAM-ANT-552ABC) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (SAM-STO-490587) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
