...
14. Position the new battery (MSF-BAT-3D335A) in the bay, pressing firmly to seat.
...
13. Connect the new display (MSF-DSP-D40A71) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (MSF-MLB-F3A27C).
...
11. Position the new charging port (MSF-CHG-7472AE) and secure with screws.
...
8. Position the new camera module (MSF-CAM-F6F200) and secure.
...
8. Position the new speaker (MSF-SPK-1832AA) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (MSF-ANT-4B90F1) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (MSF-STO-7091D5) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new keyboard (MSF-KBD-1F0370) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new trackpad (MSF-TPD-01B452) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
