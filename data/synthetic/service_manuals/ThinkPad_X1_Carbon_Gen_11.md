# ThinkPad X1 Carbon Gen 11 — Service Manual
...
14. Position the new battery (LNV-BAT-841622) in the bay, pressing firmly to seat.
...
13. Connect the new display (LNV-DSP-FD58C8) flex cables to the logic board.
...
10. Carefully lift the logic board from the top-right corner edge first.
11. Transfer SIM card reader, any shields, and thermal paste from old board if applicable.
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (LNV-MLB-0E27C1).
...
11. Position the new charging port (LNV-CHG-E555E3) and secure with screws.
...
8. Position the new camera module (LNV-CAM-651A00) and secure.
...
8. Position the new speaker (LNV-SPK-4C5701) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (LNV-ANT-9E773E) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (LNV-STO-CED457) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new keyboard (LNV-KBD-B05306) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new trackpad (LNV-TPD-D9075C) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
