# Galaxy S24 Ultra — Service Manual
...
14. Position the new battery (SAM-BAT-69A563) in the bay, pressing firmly to seat.
...
13. Connect the new display (SAM-DSP-89AAE9) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (SAM-MLB-69E492).
...
11. Position the new charging port (SAM-CHG-AC0F12) and secure with screws.
...
8. Position the new camera module (SAM-CAM-5C3ED4) and secure.
...
8. Position the new speaker (SAM-SPK-F7123A) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (SAM-ANT-3AC036) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (SAM-STO-DA9B8C) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
