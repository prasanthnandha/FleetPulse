...
14. Position the new battery (NOK-BAT-EDA440) in the bay, pressing firmly to seat.
...
13. Connect the new display (NOK-DSP-71F4D5) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (NOK-MLB-F4BDA2).
...
11. Position the new charging port (NOK-CHG-0A745D) and secure with screws.
...
8. Position the new camera module (NOK-CAM-919994) and secure.
...
8. Position the new speaker (NOK-SPK-15EB99) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (NOK-ANT-196620) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (NOK-STO-35D220) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
