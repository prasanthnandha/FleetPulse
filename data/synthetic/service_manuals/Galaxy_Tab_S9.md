...
14. Position the new battery (SAM-BAT-90ABCD) in the bay, pressing firmly to seat.
...
13. Connect the new display (SAM-DSP-79F5B5) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (SAM-MLB-6DA450).
...
11. Position the new charging port (SAM-CHG-64F8BF) and secure with screws.
...
8. Position the new camera module (SAM-CAM-5D0844) and secure.
...
8. Position the new speaker (SAM-SPK-B36F10) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (SAM-ANT-79CABF) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (SAM-STO-EE60AA) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
