...
14. Position the new battery (GGL-BAT-ADACC7) in the bay, pressing firmly to seat.
...
13. Connect the new display (GGL-DSP-B31F91) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (GGL-MLB-0BDD51).
...
11. Position the new charging port (GGL-CHG-6F5865) and secure with screws.
...
8. Position the new camera module (GGL-CAM-A7B26E) and secure.
...
8. Position the new speaker (GGL-SPK-EB481B) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (GGL-ANT-8B5914) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (GGL-STO-F235E8) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
