# ThinkPad X13 Gen 4 — Service Manual
...
14. Position the new battery (LNV-BAT-798AA1) in the bay, pressing firmly to seat.
...
13. Connect the new display (LNV-DSP-1615C4) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (LNV-MLB-E507EB).
...
11. Position the new charging port (LNV-CHG-73A5E8) and secure with screws.
...
8. Position the new camera module (LNV-CAM-529864) and secure.
...
8. Position the new speaker (LNV-SPK-54383A) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (LNV-ANT-690EB2) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (LNV-STO-C443A2) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new keyboard (LNV-KBD-68D3E1) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new trackpad (LNV-TPD-3069C5) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
