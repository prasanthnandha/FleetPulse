...
7. Locate the battery connector on the logic board. It is a press-fit connector near the bottom-left corner.
...
14. Position the new battery (LNV-BAT-1C5AFC) in the bay, pressing firmly to seat.
...
13. Connect the new display (LNV-DSP-D9CBCD) flex cables to the logic board.
...
**Part Number:** `LNV-MLB-80E359`
**Supplier:** Celestica
**Cost:** $296.27
**Estimated Repair Time:** 3.3 hours
**Difficulty:** Expert (★★★★★)
**Availability:** limited
...
10. Carefully lift the logic board from the center-right area edge first.
11. Transfer SIM card reader, any shields, and thermal paste from old board if applicable.
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (LNV-MLB-80E359).
...
5. Locate the charging port flex cable. It typically runs along the center-right area.
...
11. Position the new charging port (LNV-CHG-03D80D) and secure with screws.
...
8. Position the new camera module (LNV-CAM-F22B44) and secure.
...
**Part Number:** `LNV-SPK-9B7823`
**Supplier:** Goertek
**Cost:** $13.19
**Estimated Repair Time:** 0.7 hours
**Difficulty:** Easy (★★☆☆☆)
**Availability:** limited
...
8. Position the new speaker (LNV-SPK-9B7823) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
**Part Number:** `LNV-ANT-E8AD64`
**Supplier:** Qualcomm
**Cost:** $47.78
**Estimated Repair Time:** 2.0 hours
**Difficulty:** Moderate (★★★☆☆)
**Availability:** in_stock
...
8. Position the new antenna (LNV-ANT-E8AD64) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (LNV-STO-3F88F7) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new keyboard (LNV-KBD-2E57CC) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new trackpad (LNV-TPD-1D07C8) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
