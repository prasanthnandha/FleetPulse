# EliteBook 860 G10 — Service Manual
...
14. Position the new battery (HPQ-BAT-ABBDDD) in the bay, pressing firmly to seat.
...
13. Connect the new display (HPQ-DSP-B8C459) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (HPQ-MLB-12B351).
...
11. Position the new charging port (HPQ-CHG-F9D085) and secure with screws.
...
8. Position the new camera module (HPQ-CAM-36BBA3) and secure.
...
8. Position the new speaker (HPQ-SPK-2B3C38) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (HPQ-ANT-8DFB96) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (HPQ-STO-F5C306) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new keyboard (HPQ-KBD-9FFF81) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new trackpad (HPQ-TPD-90FBD9) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
