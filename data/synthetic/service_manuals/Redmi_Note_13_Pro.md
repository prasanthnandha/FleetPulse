# Redmi Note 13 Pro — Service Manual
...
14. Position the new battery (XMI-BAT-EFE3AB) in the bay, pressing firmly to seat.
...
13. Connect the new display (XMI-DSP-B56065) flex cables to the logic board.
...
12. Apply new thermal paste/thermal pad to the SoC area of the new logic board (XMI-MLB-2E4B7C).
...
11. Position the new charging port (XMI-CHG-B731F3) and secure with screws.
...
8. Position the new camera module (XMI-CAM-1908D1) and secure.
...
8. Position the new speaker (XMI-SPK-ED0E12) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new antenna (XMI-ANT-B739D6) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
...
8. Position the new storage (XMI-STO-DFDFEC) and secure.
9. Reconnect the flex cable to the logic board.
10. Reconnect the battery.
