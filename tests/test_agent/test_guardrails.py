...
class TestGuardrails:
    def test_pii_sanitization_email_and_phone(self):
        ...
        raw_text = (
            "Contact technician John at john.doe@enterprise.com or call +1 (555) 234-5678 regarding device DEV-1029."
        )
    ...
    def test_anti_hallucination_intercepts_fabricated_part(self):
        ...
        """
        model_hallucination = "I recommend replacing the screen using part SAM-DSP-FAB999 from supplier Acme."
        tool_results = [
            {
                "found": True,
                "part_info": {
    ...
    def test_anti_hallucination_permits_verified_part(self):
        ...
        """
        model_valid_text = "Order replacement battery part APL-BAT-998877 from LG Chem."
        tool_results = [
            {
                "found": True,
                "part_info": {
